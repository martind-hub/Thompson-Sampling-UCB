...
# plots the accumulated regret over time 
#plot(x = 1:T2_TS, y = average_regret, ylim = c(0, 70), type = "l", col = "red", xlab = "Time", ylab = "Regret", main = "Thompson - red, UCB - blue")
...
######################################################################
#### Thompson Sampling with good knowledge
######################################################################
arms <- arms_initial
...
###################################################################
#### Comparing all Thompson Samplings with UCB
###################################################################
## ploting the cumulative regret for the two algorithms
